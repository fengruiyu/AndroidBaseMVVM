...
object DependencyConfig {
    ...
    object Version {
        ...
        // AndroidX--------------------------------------------------------------
        const val AppCompat = "1.3.1"                       //Android 应用兼容性支持库
        const val CoreKtx = "1.7.0"                         //Kotlin 标准库的 Android 扩展
        const val ConstraintLayout = "2.1.3"                // 约束布局
        const val TestExtJunit = "1.1.2"                    //编写单元测试的 JUnit 扩展库
        const val TestEspresso = "3.3.0"                    //编写 UI 测试的 Espresso 库
        const val ActivityKtx = "1.5.1"                     //Kotlin 扩展库中提供的用于 Activity 的 Kotlin 扩展函数
        const val FragmentKtx = "1.5.2"                     //Kotlin 扩展库中提供的用于 Fragment 的 Kotlin 扩展函数
        const val MultiDex = "2.0.1"                        //用于支持多 Dex 文件的 MultiDex 库
